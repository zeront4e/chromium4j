...
class DownloaderLatestTrunkChromiumUtil {
    public static String GIT_HUB_ORGANIZATION = "release-monitoring-project";
    public static String GIT_HUB_REPOSITORY = "chromium-release-tracker";
    public static String GIT_HUB_ASSET_NAME = "chromium_download_links.json";
    ...
    public static final String LINUX_ARM64_ARCHITECTURE_PROPERTY = "chromium4j.download-url.latest-trunk.linux_arm64";
    public static final String LINUX_ARM32_ARCHITECTURE_PROPERTY = "chromium4j.download-url.latest-trunk.linux_arm32";
